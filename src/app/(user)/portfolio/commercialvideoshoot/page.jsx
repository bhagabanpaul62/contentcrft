...
function Commercialvideoshoot() {
  return (
    <div className="w-full min-h-screen dark:bg-black bg-white px-4 py-20 flex flex-col justify-between items-center text-center">
      {/* Header */}
      <div className="max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-bold text-purple-700 dark:text-purple-400 mb-4">
